...
export const TaskDetailModal: React.FC<TaskDetailModalProps> = ({
  ...
  return <div className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center sm:p-4 bg-black/65 backdrop-blur-md">
    <section role="dialog" aria-modal="true" className="viewport-dialog bg-[#18181B] sm:rounded-[2rem] rounded-t-[2rem] max-w-4xl w-full max-h-[calc(100dvh-.5rem)] sm:max-h-[calc(100dvh-2rem)] overflow-hidden shadow-2xl border border-zinc-800 flex flex-col">
      ...
      <footer className="task-detail-footer shrink-0 px-4 sm:px-7 pt-3 sm:py-4 bg-zinc-900/95 backdrop-blur border-t border-zinc-800 flex flex-col sm:flex-row sm:flex-wrap sm:items-center justify-between gap-2 sm:gap-3" style={{ paddingBottom: 'calc(.75rem + env(safe-area-inset-bottom))' }}>
